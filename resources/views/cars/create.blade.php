...
<div class="max-w-md mx-auto bg-white shadow-md rounded-lg p-6">
    ...
    <form action="/cars/store" method="POST">
        ...
        <div class="mb-4">
            <label for="horsepower" class="block text-sm font-medium text-gray-700">Caballs:</label>
            <input type="number" name="horsepower" required class="mt-1 block w-full border border-gray-300 rounded-md p-2" placeholder="Enter car caballs">
        </div>
