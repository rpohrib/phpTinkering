...
<div class="max-w-lg mx-auto bg-white shadow-md rounded-lg p-6">
    ...
    <form action="/cars/update/<?= $car->id ?>" method="POST">
        ...
        <div class="mb-4">
            <label for="horsepower" class="block text-gray-700">Caballs:</label>
            <input type="number" name="horsepower" value="<?= htmlspecialchars($car->horsepower) ?>" class="mt-1 block w-full border border-gray-300 rounded-md p-2" required>
        </div>
